...
class VectorStore:
    ...
    def get_course_outline(self, course_name: str) -> Optional[Dict[str, Any]]:
        """
        Get complete course outline by fuzzy-matching a course name.

        Args:
            course_name: Full or partial course title (semantic matching applied)

        Returns:
            Dict with title, instructor, course_link, lesson_count, lessons.
